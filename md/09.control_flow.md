...
> **针对 C/C++ 程序员的提示**
> 
> Python 中不存在 `switch` 语句。你可以通过使用 `if..elif..else` 语句来实现同样的事情（在某些情况下，使用一部[字典](12.data_structures.html#dictionary)能够更快速地完成）。
...
[ __](08.op_exp.html) [ __](10.functions.html)
